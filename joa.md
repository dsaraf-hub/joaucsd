    ...
    <div class="container wow fadeIn">
      <div class="row">
        ...
        <p class="cta-text" style="text-align:right">
          ...
          <li style="text-align:right"><a href="http://joa.ucsd.edu/joa/joa_download_mac.html">Mac specific installation instructions</a></li>
          <li style="text-align:right"><a href="http://joa.ucsd.edu/joa/joa_download_windows.html">Windows specific installation instructions</a></li>
        </p>
      </div>
    </div>
  </div>
